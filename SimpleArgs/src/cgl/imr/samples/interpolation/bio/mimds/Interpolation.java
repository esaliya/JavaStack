...
import cgl.imr.samples.interpolation.type.DistancePoint;
...
import cgl.imr.samples.interpolation.util.DistanceCalculation;
...
//			System.out.println("id: " + i + "after " + nearestDistancePoints.size());
			...
			Point point = new Point((offset + i + sampleSize), v_point, decideGroupNearest(distancePoints));
	...
	private static int decideGroupNearest(List<DistancePoint> distancePoints){
