...
/**
 * RayTraceSubViewResponse bean class
 */

public class RayTraceSubViewResponse
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"rayTraceSubViewResponse".equals(type)) {
                            ...
                            return (RayTraceSubViewResponse) edu.indiana.cs.b534.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
