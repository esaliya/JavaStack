...
/**
 * RayTraceURLResponse bean class
 */

public class RayTraceURLResponse
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"rayTraceURLResponse".equals(type)) {
                            ...
                            return (RayTraceURLResponse) edu.indiana.cs.b534.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
