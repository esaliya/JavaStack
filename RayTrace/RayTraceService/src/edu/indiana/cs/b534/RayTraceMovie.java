...
public class RayTraceMovie
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
     ...
     */
    protected void validateCamera(edu.indiana.cs.b534.CameraSetup[] param) {
     ...
     *
     * @param param edu.indiana.cs.b534.CameraSetup
     */
    public void addCamera(edu.indiana.cs.b534.CameraSetup param) {
        if (localCamera == null) {
            localCamera = new edu.indiana.cs.b534.CameraSetup[]{};
        }
        ...
        list.add(param);
        this.localCamera =
                (edu.indiana.cs.b534.CameraSetup[]) list.toArray(
                        new edu.indiana.cs.b534.CameraSetup[list.size()]);
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"rayTraceMovie".equals(type)) {
                            ...
                            return (RayTraceMovie) edu.indiana.cs.b534.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://b534.cs.indiana.edu", "camera").equals(reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        list2.add(edu.indiana.cs.b534.CameraSetup.Factory.parse(reader));
                    }
                    ...
                    object.setCamera((edu.indiana.cs.b534.CameraSetup[])
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                    edu.indiana.cs.b534.CameraSetup.class,
                                    list2));
