 ...
 *
 */
public class DData extends ApplicationFrame implements ActionListener {
     ...
     */
    public DData(final String title) {
        ...
        for (int i = 0; i < SUBPLOT_COUNT; i++) {
            ...
            final TimeSeries series = new TimeSeries("Random " + i);
...
//        chart.getLegend().setAnchor(Legend.EAST);
  ...
  //      plot.setAxisOffset(new Spacer(Spacer.ABSOLUTE, 4, 4, 4, 4));
    ...
    public static void main(final String[] args) {
        ...
        final DData demo = new DData("Dynamic Data Demo 3");
        demo.pack();
