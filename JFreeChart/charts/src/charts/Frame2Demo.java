...
public class Frame2Demo extends WindowAdapter implements ActionListener {
  ...
  protected static Image getFDImage() {
    java.net.URL imgURL = Frame2Demo.class.getResource("images/FD.jpg");
    if (imgURL != null) {
  ...
  private static void createAndShowGUI() {
    ...
    JFrame frame = new JFrame("Frame2Demo");
    frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

    // Create and set up the content pane.
    Frame2Demo demo = new Frame2Demo();
